...
def onestim() :
    ...
    if run<=nr :
      ...
      #blockStore= 'Block store:'+blckstr.get()
...
while tdtnotloaded:
  ...
  if stimsize>0:
    tdtnotloaded=0
      ...
      print('Could not connect to TDT. Stimbufsize',stimsize,'Retry in 3 seconds',tdt)
      time.sleep(3)
  
print ('Connected to TDT!')    
